                            ...
                            <div class="product">
                                <div class="product-img">
                                    ...
                                    <div class="product-label">
                                        <span class="badge badge-danger" style="color:rgb(245, 240, 240);font-weight:bold">Offer!!</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <div class="product-body">
                                    ...
                                    <p style="color:rgb(243, 243, 245);font-weight:bold;" class="product-category badge badge-success">Category:&nbsp;&nbsp;<span style="color:rgb(15, 15, 15);font-weight:bold;">{{$product->category->name}}</span></p>
