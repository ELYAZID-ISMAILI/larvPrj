                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr id="deleteItem_{{$c[3]}}">
                            ...
                            <td class="row">
                                <button type="button" id="sub" value={{$p->id}} class="btn btn-secondary sub col-sm-2" data-rel={{$c[3]}} data-rel2={{$p->discount}}>-</button>
                                
                                <input type="number" id="quantity" name={{$p->id}} class=" form-control quantity col-sm-6" value={{$c[1]}} min="1" max="{{$p->stock}}" />
                                <button type="button" id="add" value={{$p->id}} data-rel={{$c[3]}} data-rel2={{$p->discount}} class="btn btn-secondary add col-sm-2">+</button>  
                            </td>
                            <td>
